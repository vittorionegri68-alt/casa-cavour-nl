        ...
        <div style={{ display: "grid", gap: "20px" }}>
          {visibili.map(post => (
            ...
            >
              ...
              <small>
                {new Date(post.data).toLocaleDateString("nl-NL")}
              </small>
            </div>
          ))}
        </div>
          ...
          <div>
            ...
            {post.contenuto.map((blocco, i) => {
              ...
              if (blocco.tipo === "titoletto") {
                return <h3 key={i}>{blocco.testo}</h3>;
              }
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr", gap: "3rem", marginBottom: "3rem" }} className="footer-grid">
          ...
          <div>
            ...
            {[["Appartement","appartement"],["Locatie","locatie"],["Ervaringen","ervaringen"],["Recensies","recensies"]].map(([l,id]) => (
