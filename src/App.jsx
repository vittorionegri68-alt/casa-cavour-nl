        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "3rem", width: "100%", paddingTop: "5rem", paddingBottom: "3rem", flexWrap: "wrap" }}>
          <div style={{ flex: "1 1 320px", minWidth: 0 }}>
            ...
            <p style={{ opacity: loaded?1:0, transform: loaded?"translateY(0)":"translateY(24px)", transition: "all 0.85s ease 0.46s", fontSize: "clamp(0.93rem,1.8vw,1.08rem)", color: C.textMid, lineHeight: 1.82, margin: "0 0 2rem", fontFamily: "'DM Sans',sans-serif" }}>
              Casa Cavour is een design vakantieappartement met volledig ingerichte keuken in het historische centrum van Bertinoro, een middeleeuws heuvelstadje in Emilia-Romagna bekend als het <em style={{ color: C.text }}>"Balkon van de Romagna"</em> vanwege het panoramisch uitzicht over de Po-vlakte en de Adriatische kust. Gelegen aan de Via Cavour, op een steenworp van het centrale plein en de befaamde wijntradities van het dorp, is het de ideale uitvalsbasis voor koppels en reizigers die de authentieke Romagna willen ontdekken: wijnkelders, middeleeuwse dorpen, Sangiovese, Piadina Romagnola. Op slechts 15 min van Cesena, 20 min van Forli, 40 min van Rimini, 35 min van San Marino en 60 min van Bologna. Beschikbaar voor kortetermijnverblijf in het Italiaans, Engels en Nederlands.
            </p>
